...
# Supports two types of qualifications:
...
#
# Optional:
#   distribution                - 1st party code.

ALL_REQUIRED_COMPONENTS = ["docs"]

ALL_OPTIONAL_COMPONENTS = [os.path.join("distribution")]
...
def parse_arguments():
    ...
    parser.add_argument("--root", required=True, help="Location of the root directory.")
